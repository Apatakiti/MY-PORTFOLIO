...
const fillData = ({
  name, description, featuredImage, skills,
}) => {
  ...
  const skillM = document.querySelectorAll('#poped > .skilling > ul > li.skill');
...
const fillData2 = ({
  nameD, descriptionD, featuredImageD, skills,
}) => {
  ...
  const skill2 = document.querySelectorAll('#popedD > .skillingD > ul > li.skill2');
